...
declare const VITE_URL_PREFIX: string;
...
type Distribution = FloatDistribution | IntDistribution | CategoricalDistribution;
...
type UserAttrFormWidget = ObjectiveChoiceWidget | ObjectiveSliderWidget | ObjectiveTextInputWidget;
